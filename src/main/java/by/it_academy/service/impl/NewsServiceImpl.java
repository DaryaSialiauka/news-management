...
public class NewsServiceImpl implements NewsService {
	...
	// private final static NewsDataValidation validProvider =
	// ValidationProvider.getInstance().getNewsDataValidation();
	...
	public int addNews(News news) throws ServiceException, AddNewsServiceException, DataNewsValidationException {
		...
		try {
			...
			validNews = valid.titleValid(news.getTitle()).briefValid(news.getBrief()).contentValid(news.getContent())
					.authorValid(news.getId_author()).dateValid(news.getDate_create()).build();
	...
	@Override
	public boolean updateNews(News news) throws AddNewsServiceException, ServiceException, DataNewsValidationException {
		...
		try {
			...
			provider.updateNews(news);
		} catch (AddNewsDAOException e) {
			throw new AddNewsServiceException(e.getMessage(), e);
		} catch (DAOException e) {
