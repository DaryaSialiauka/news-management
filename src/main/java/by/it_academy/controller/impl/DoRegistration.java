...
public class DoRegistration implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			LOG.error(e);
			userNotAddedRedirect(request, response, paramUser.append(errorMapInput(e)));
		}
	}
	...
	private static void userNotAddedRedirect(HttpServletRequest request, HttpServletResponse response,
		...
		url.append(JSPPageName.REGISTER_PAGE).append(AttributeAndParameter.SEPARATOR).append(AttributeAndParameter.BODY)
				...
				.append(AttributeAndParameter.EQUALS).append(AttributeAndParameter.ERROR_ADD_USER).append(param);
	...
	private static StringBuilder errorMapInput(DataUserValidationException e) {

		StringBuilder param = new StringBuilder();

		Iterator<Map.Entry<InputDataUserValidation, String>> entries = e.getErrorMap().entrySet().iterator();
		while (entries.hasNext()) {
			Map.Entry<InputDataUserValidation, String> entry = entries.next();
			param.append(AttributeAndParameter.SEPARATOR)
					...
					.append(AttributeAndParameter.SEPARATOR).append(entry.getKey().name().toLowerCase())
