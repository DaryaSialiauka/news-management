...
public class DoAddNews implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendRedirect(JSPPageName.ADD_NEWS_PAGE + AttributeAndParameter.SEPARATOR
					...
					+ AttributeAndParameter.ERROR_ADD_NEWS + errorListInput(e));
		}
	}
	...
	private static String errorListInput(DataNewsValidationException e) {

		String param = "";
		List<InputDataNewsValidation> errorList;

		errorList = e.getErrorList();

		for (InputDataNewsValidation error : errorList) {
